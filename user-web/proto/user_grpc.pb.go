...
type UserClient interface {
	...
	GetUserByUserName(ctx context.Context, in *UserNameRequest, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) GetUserByUserName(ctx context.Context, in *UserNameRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServer) GetUserByUserName(context.Context, *UserNameRequest) (*UserInfoResponse, error) {
